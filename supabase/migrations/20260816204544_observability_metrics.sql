-- Operational observability for scheduled jobs and physical printing.
-- These tables are internal: the application accesses them with service_role
-- and the public roles receive no direct table privileges.
