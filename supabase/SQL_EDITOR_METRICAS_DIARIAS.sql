-- Cole este arquivo no Supabase > SQL Editor e execute uma vez.
-- Ele cria apenas indices para as metricas diarias.
-- Nenhum ticket, avaliacao ou outro dado sera apagado.
